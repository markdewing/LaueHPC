...
int main( int argc, char** argv)
{
    ...
    real_Double_t magma_time_allocate, magma_time_h2d;
    magma_int_t magma_memory;
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
	    ...
	    magma_memory = magma_mem_size( opts.queue );
	    printf("magma_memory= %i\n",magma_memory);
	    
	    magma_time_allocate = magma_sync_wtime( opts.queue );
	    ...
	    magma_time_allocate = magma_sync_wtime( opts.queue ) - magma_time_allocate;
	    ...
	    magma_time_h2d = magma_sync_wtime( opts.queue );
	    ...
	    magma_time_h2d = magma_sync_wtime( opts.queue ) - magma_time_h2d;
	    ...
	    printf("magma_time_allocate= %f  magma_time_h2d= %f\n",magma_time_allocate*1000.,magma_time_h2d*1000);
